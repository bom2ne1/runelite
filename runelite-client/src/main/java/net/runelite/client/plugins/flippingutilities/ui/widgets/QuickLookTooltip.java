...
import net.runelite.client.plugins.flippingutilities.utilities.SlotInfo;
import net.runelite.client.plugins.flippingutilities.utilities.SlotPredictedState;
import net.runelite.client.plugins.flippingutilities.utilities.WikiItemMargins;
...
public class QuickLookTooltip implements LayoutableRenderableEntity {
    ...
    public void setGraphData(TimeseriesResponse timeseries, net.runelite.client.plugins.flippingutilities.model.Timestep timestep, int offerPrice) {
