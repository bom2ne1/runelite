package net.runelite.client.plugins.flippingutilities.ui.recipeflips;
...
import net.runelite.client.plugins.flippingutilities.ui.statistics.items.OfferPanel;
