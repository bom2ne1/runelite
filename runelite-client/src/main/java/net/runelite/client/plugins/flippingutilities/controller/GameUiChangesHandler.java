...
import net.runelite.client.plugins.flippingutilities.ui.offereditor.AbstractOfferEditorPanel;
import net.runelite.client.plugins.flippingutilities.ui.offereditor.OfferEditorContainerPanel;
import net.runelite.client.plugins.flippingutilities.ui.widgets.OfferEditor;
import net.runelite.client.plugins.flippingutilities.utilities.Constants;
import net.runelite.client.plugins.flippingutilities.utilities.WikiRequest;
    ...
    public void onVarbitChanged(VarbitChanged event) {
        ...
        if (varpId == VarPlayerID.TRADINGPOST_SEARCH) {
            ...
            if (varpValue != -1 && varpValue != 0) {
                highlightOffer(varpValue);
            } else if (highlightedItem.isPresent()) {
    ...
    public void onWidgetLoaded(WidgetLoaded event) {
        ...
        switch (groupId) {
            ...
            case InterfaceID.INVENTORY: //this is the same as what GE_HISTORY_TAB_WIDGET_ID was, probably a repurposed config name
                ...
                //this (id 149 and not id 383) will also trigger when the player just exits out of the ge interface
                // offer window screen, which is good as then the highlight won't linger in that case.
